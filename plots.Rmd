...
The frequency deceases as the number of nomination increases. Most (902) actors haven't been nominated. 583 actors have one nomination. Four actors have eleven, and another four actors have twelve nominations.
...
ggplot(win_df, aes(x = Wining_Oscar, y = Frequency, fill = as.factor(Wining_Oscar))) +
  ...
  theme(legend.position = "none")
```
There are 1670 observations but 1431 of them have zero Oscar win. We have huge imbalance in the data set. It is worth noting that there are two four-time Oscar winners.
